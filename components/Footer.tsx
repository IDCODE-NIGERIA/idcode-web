...
export function Footer() {
  ...
  return (
    <footer className="w-full bg-[#93D291] pt-12 sm:pt-16 lg:pt-24 pb-8 overflow-hidden relative text-black">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-24 mb-12 sm:mb-16 lg:mb-24">
          ...
          <div className="flex flex-col justify-between items-start h-full">
            <div className="max-w-md mb-6 sm:mb-8">
               ...
               <p className="text-sm sm:text-base text-black/80 font-medium max-w-sm">
            ...
            >
              {"IDCODE".split("").map((letter, i) => (
                <motion.span
                  ...
                  className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-black tracking-tighter leading-none block"
            ...
            <div className="flex flex-col space-y-4 sm:space-y-6">
              ...
              <ul className="flex flex-col space-y-2 sm:space-y-4">
                {NAV_LINKS.products.map((item, i) => (
                  <li key={i}>
                    <Link href={item.link} className="text-xs sm:text-sm text-black/80 hover:text-black font-medium transition-colors">
                      {item.name}
                    </Link>
                  </li>
                ))}
        ...
        {/* Separator */}
        <div className="w-full h-[1px] bg-black/20 mb-6 sm:mb-8"></div>

        {/* Bottom Bar: Policies & Socials */}
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 sm:gap-8">
          <ul className="flex flex-wrap items-center gap-x-3 sm:gap-x-6 gap-y-2 sm:gap-y-3 text-xs sm:text-sm text-black/70 font-medium">
